...
//    }
    ...
    public static void main(String[] args) {
        ...
        try {
//        APIClient TestClient = new APIClient("http://localhost:8080/dataTransferWeb/Doc").addParameter("id", "22");

        APIClient TestClient = new APIClient("http://localhost:8080/dataTransferWeb/Doc/12");
