...
@ComponentScan({ "com.doxbit.dataTransfer" })
@EnableJpaRepositories(basePackages = "com.doxbit.dataTransfer.dao")
public class PersistenceJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.doxbit.dataTransfer.model"});
